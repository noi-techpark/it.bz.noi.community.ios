...
private let keepSize: CGFloat = 0
extension UIFont {
    ...
    public static func preferredFont(
        ...
        return UIFont(descriptor: desc!, size: keepSize)
    }
    ...
    public static func preferredMonospacedDigitSystemFont(
        forTextStyle textStyle: TextStyle,
        weight: Weight
    ) -> UIFont {
        let metrics = UIFontMetrics(forTextStyle: textStyle)
    ...
    @available(iOS 13.0, *)
    public static func preferredMonospacedSystemFont(
        forTextStyle textStyle: TextStyle,
        weight: Weight
    ) -> UIFont {
        let metrics = UIFontMetrics(forTextStyle: textStyle)
